...
* My name: Long Nguyen.
* My favourite quote: Begin with the end in mind.

### Screenshots
![program](program_screenshot.png)
![whirlwindbook](WhirlwindTourOfPython_chapter0_intro.png)
![pdshbook](PythonDataScienceHandbook_chapter0_preface.png)
